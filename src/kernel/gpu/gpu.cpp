...
void Gpu::loadPalette(){
	...
	DmaArrayCopy(3, Palette, OBJ_PALETTE, 16);
	...
	//	 NUMBERS[i] = i;
		 ...
		 *(u16*)(OBJ_PALETTE+(i*0x20))		=	*(u16*)(OBJ_PALETTE);
		 *(u16*)(OBJ_PALETTE+(i*0x20)+0x10)	=	*(u16*)(OBJ_PALETTE+(i*0x2));
	 }					
}
...
const u16 obj_tileset[1024] = { 
	0x1080, 0x1081, 0x1082, 0x1083, 0x1089, 0x108a, 0x108b, 0x108c, 0x0008, 0x0009, 0x000a, 0x000b, 0x000c, 0x000d, 0x000e, 0x000f, 0x0010, 0x0011, 0x0012, 0x0013, 0x0014, 0x0015, 0x0016, 0x0017, 0x0018, 0x0019, 0x11df, 0x21df, 0x2050, 0x2051, 0x2052, 0x2054, 
	0x1070, 0x1071, 0x1072, 0x1073, 0x1074, 0x1075, 0x1076, 0x1078, 0x1079, 0x107a, 0x107b, 0x107c, 0x107d, 0x107e, 0x107f, 0x0000, 0x1099, 0x10a9, 0x10b9, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
	0x1090, 0x1090, 0x1090, 0x1090, 0x1090, 0x1090, 0x1090, 0x1090, 0x1090, 0x1091, 0x1092, 0x1093, 0x1094, 0x0000, 0x0000, 0x0000, 0x109a, 0x10a9, 0x10b9, 0x0000, 0x109b, 0x10a9, 0x10b9, 0x0000, 0x109c, 0x10a9, 0x10b9, 0x0000, 0x109d, 0x10a9, 0x10b9, 0x0000,	
	0x10a0, 0x10a0, 0x10a0, 0x10a0, 0x10a0, 0x10a1, 0x10a2, 0x10a3, 0x10a4, 0x10a4, 0x10a4, 0x10a4, 0x10a4, 0x0000, 0x0000, 0x0000, 0x109d, 0x10aa, 0x10b9, 0x0000, 0x109d, 0x10ab, 0x10b9, 0x0000, 0x109d, 0x10ac, 0x10b9, 0x0000, 0x109d, 0x10ad, 0x10b9, 0x0000,
	0x10b0, 0x10b1, 0x10b2, 0x10b3, 0x10b4, 0x10b4, 0x10b4, 0x10b4, 0x10b4, 0x10b4, 0x10b4, 0x10b4, 0x10b4, 0x0000, 0x0000, 0x0000, 0x109d, 0x10ad, 0x10ba, 0x0000, 0x109d, 0x10ad, 0x10bb, 0x0000, 0x109d, 0x10ad, 0x10bc, 0x0000, 0x109d, 0x10ad, 0x10bd, 0x0000,
	0x10C0, 0x10C1, 0x10C2, 0x10C3, 0x10C4, 0x10C5, 0x10C6, 0x10C7, 0x10C8, 0x10C9, 0x10CA, 0x10CB, 0x10CC, 0x10CD, 0x10CE, 0x10CF, 0x10D0, 0x10D1, 0x10D2, 0x10D3, 0x10D4, 0x10D5, 0x10D6, 0x10D7, 0x10D8, 0x10D9, 0x10DA, 0x10DB, 0x10DC, 0x10DD, 0x10DE, 0x10DF, 
	0x10e0, 0x10E1, 0x10E2, 0x10E3, 0x10E4, 0x10E5, 0x10E6, 0x10E7, 0x10E8, 0x10E9, 0x10EA, 0x10EB, 0x10EC, 0x10ED, 0x10EE, 0x10EF, 0x10F0, 0x10F1, 0x10F2, 0x10F3, 0x10F4, 0x10F5, 0x10F6, 0x10F7, 0x10F8, 0x10F9, 0x10FA, 0x10FB, 0x10FC, 0x10FD, 0x10FE, 0x10FF, 
...
void Gpu::init(){
	...
	// Load OBJ tilesets
	/*DmaCopy(3, TILESET_0		  ,OBJ_MODE0_VRAM		, 0x0400, 16);//256 tiles
	DmaCopy(3, TILESET_1 + 0x1000 ,OBJ_MODE0_VRAM		,   0x80, 16);//512 tiles
	DmaCopy(3, TILESET_1 + 0x1120 ,OBJ_MODE0_VRAM+0x080	,   0x80, 16);//512 tiles
	DmaCopy(3, TILESET_1 + 0x1120 ,OBJ_MODE0_VRAM+0x380	,   0x80, 16);//512 tiles
	// DmaCopy(3, TILESET_1 + 0x11D0 ,OBJ_MODE0_VRAM+0x400	,   0x80, 16);//512 tiles
	DmaCopy(3, TILESET_1 + 0xE00  ,OBJ_MODE0_VRAM+0x400	,  0x100, 16);//512 tiles
	DmaCopy(3, TILESET_1 + 0xF00  ,OBJ_MODE0_VRAM+0x500	,  0x100, 16);//512 tiles
	DmaCopy(3, TILESET_1 + 0x1200  ,OBJ_MODE0_VRAM+0x600	,  0x100, 16);//512 tiles
	
	// Create Horizontal vumeter animation
	DmaCopy(3, TILESET_1 + 0x1400  ,OBJ_MODE0_VRAM+0x600+0x400	,  0x100, 16);//512 tiles
	DmaCopy(3, TILESET_1 + 0x1600  ,OBJ_MODE0_VRAM+0x600+0x800	,  0x100, 16);//512 tiles
	DmaCopy(3, TILESET_2,OBJ_MODE0_VRAM+0x5000	, 0x2000, 16);//512 tiles
	//DmaCopy(3, TILESET_2+0x2000,OBJ_MODE0_VRAM+0x7000, 0x1000, 16);//256 tiles
	*/
	for(int y=0,i=0; y<0x16; y++){
		for(int x=0; x<32; x++,i++){
			 u8 layer = (obj_tileset[i]&0xf000)>>12;
			u16 value = obj_tileset[i]&0x0fff;
			switch(layer){
				case 0: DmaCopy(3, TILESET_0+(0x20*value),OBJ_MODE0_VRAM+(i*0x20), 0x20, 16); break;
				case 1: DmaCopy(3, TILESET_1+(0x20*value),OBJ_MODE0_VRAM+(i*0x20), 0x20, 16); break;
				case 2: DmaCopy(3, TILESET_2+(0x20*value),OBJ_MODE0_VRAM+(i*0x20), 0x20, 16); break;
				// case 3: DmaCopy(3, TILESET_3,OBJ_MODE0_VRAM+(i*0x20), 0x20, 16); continue;
				default: break;
			}
		}
	}
