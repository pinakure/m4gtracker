...
extern const Viewport VIEWPORT_TRK;

extern const Viewport VIEWPORT_CH0;

extern const Viewport VIEWPORT_INS;
extern const Viewport VIEWPORT_CFG;
...
const Region REGION_MAP_2_INS_WAV = { 		0xFF,	0xFF, 	0x0e, 	0x2c, 0x0e, 0x14, 	NULL, 				NULL, 				NULL, 				NULL, 					0x01, 	&CACHE_DIRTY_MAP_2,	INS_WAV_CONTROLS, 		NULL, 				(Control*)&(INS_WAV_CONTROLS[CONTROL_INS_WAV_TYPE]),				VARS_INS_WAV ,		updateINS_WAV,		NULL			}; /*INS_WAV*/
const Region REGION_MAP_2_INS_FMW = { 		0xFF,	0xFF, 	0x1c, 	0x2c, 0x0e, 0x14, 	NULL, 				NULL, 				NULL, 				NULL, 					0x01, 	&CACHE_DIRTY_MAP_2,	INS_FMW_CONTROLS, 		NULL, 				(Control*)&(INS_FMW_CONTROLS[CONTROL_INS_FMW_TYPE]),				VARS_INS_FMW ,		updateINS_FMW,		NULL			}; /*INS_FMW*/
const Region REGION_MAP_2_INS_SMP = { 		0xFF,	0xFF, 	0x2a, 	0x2c, 0x0e, 0x14, 	NULL, 				NULL, 				NULL, 				NULL, 					0x01, 	&CACHE_DIRTY_MAP_2,	INS_SMP_CONTROLS, 		NULL, 				(Control*)&(INS_SMP_CONTROLS[CONTROL_INS_SMP_TYPE]),				VARS_INS_SMP ,		updateINS_SMP,		NULL			}; /*INS_SMP*/
const Region REGION_MAP_2_INS_PWM = { 		0xFF,	0xFF, 	0x00, 	0x2c, 0x0e, 0x14, 	NULL, 				NULL, 				NULL, 				NULL, 					0x01, 	&CACHE_DIRTY_MAP_2,	INS_PWM_CONTROLS, 		NULL, 				(Control*)&(INS_PWM_CONTROLS[CONTROL_INS_PWM_TYPE]),				VARS_INS_PWM ,		updateINS_PWM,		NULL			}; /*INS_PWM*/
