...
const Region REGION_MAP_2_PAT = { 			0xFF,	0xFF, 	0x00, 	0x00, 0x1e, 0x14, 	&REGION_MAP_1_LIVE1,&REGION_MAP_3_TRK, 	&REGION_MAP_2_SNG, 	&REGION_MAP_2_INS, 		0x01, 	&CACHE_DIRTY_MAP_2,	PAT_CONTROLS, 			PAT_DISPLAYS, 		  (Control*)&(PAT_CONTROLS[0]) 										, VARS_PAT 			, PatEdit::update		, NULL			}; /*PAT*/
