...
//	{ x	 		, y		, up					, right					, down					, left					, cache							, var						, callback			},
	...
	{ COLUMN00-1, 0x04 	, CTL( SOLO_LEFT_02	  ) , CTL( PATTERNS_B_00  ) , CTL( PATTERNS_A_01  ) , CTL( PATTERNS_F_00  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 0 ,TRANSPOSE[  0 ]), &cb_patterns_0_00	},
	{ COLUMN00-1, 0x05 	, CTL( PATTERNS_A_00  )	, CTL( PATTERNS_B_01  ) , CTL( PATTERNS_A_02  ) , CTL( PATTERNS_F_01  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 0 ,TRANSPOSE[  1 ]), &cb_patterns_0_01	},
	{ COLUMN00-1, 0x06 	, CTL( PATTERNS_A_01  )	, CTL( PATTERNS_B_02  ) , CTL( PATTERNS_A_03  ) , CTL( PATTERNS_F_02  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 0 ,TRANSPOSE[  2 ]), &cb_patterns_0_02	},
	{ COLUMN00-1, 0x07 	, CTL( PATTERNS_A_02  )	, CTL( PATTERNS_B_03  ) , CTL( PATTERNS_A_04  ) , CTL( PATTERNS_F_03  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 0 ,TRANSPOSE[  3 ]), &cb_patterns_0_03	},
	{ COLUMN00-1, 0x08 	, CTL( PATTERNS_A_03  )	, CTL( PATTERNS_B_04  ) , CTL( PATTERNS_A_05  ) , CTL( PATTERNS_F_04  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 0 ,TRANSPOSE[  4 ]), &cb_patterns_0_04	},
	{ COLUMN00-1, 0x09 	, CTL( PATTERNS_A_04  )	, CTL( PATTERNS_B_05  ) , CTL( PATTERNS_A_06  ) , CTL( PATTERNS_F_05  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 0 ,TRANSPOSE[  5 ]), &cb_patterns_0_05	},
	{ COLUMN00-1, 0x0a 	, CTL( PATTERNS_A_05  )	, CTL( PATTERNS_B_06  ) , CTL( PATTERNS_A_07  ) , CTL( PATTERNS_F_06  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 0 ,TRANSPOSE[  6 ]), &cb_patterns_0_06	},
	{ COLUMN00-1, 0x0b 	, CTL( PATTERNS_A_06  )	, CTL( PATTERNS_B_07  ) , CTL( PATTERNS_A_08  ) , CTL( PATTERNS_F_07  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 0 ,TRANSPOSE[  7 ]), &cb_patterns_0_07	},
	{ COLUMN00-1, 0x0c 	, CTL( PATTERNS_A_07  )	, CTL( PATTERNS_B_08  ) , CTL( PATTERNS_A_09  ) , CTL( PATTERNS_F_08  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 0 ,TRANSPOSE[  8 ]), &cb_patterns_0_08	},
	{ COLUMN00-1, 0x0d 	, CTL( PATTERNS_A_08  )	, CTL( PATTERNS_B_09  ) , CTL( PATTERNS_A_0A  ) , CTL( PATTERNS_F_09  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 0 ,TRANSPOSE[  9 ]), &cb_patterns_0_09	},
	{ COLUMN00-1, 0x0e 	, CTL( PATTERNS_A_09  )	, CTL( PATTERNS_B_0A  ) , CTL( PATTERNS_A_0B  ) , CTL( PATTERNS_F_0A  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 0 ,TRANSPOSE[ 10 ]), &cb_patterns_0_0A	},
	{ COLUMN00-1, 0x0f 	, CTL( PATTERNS_A_0A  )	, CTL( PATTERNS_B_0B  ) , CTL( PATTERNS_A_0C  ) , CTL( PATTERNS_F_0B  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 0 ,TRANSPOSE[ 11 ]), &cb_patterns_0_0B	},
	{ COLUMN00-1, 0x10 	, CTL( PATTERNS_A_0B  )	, CTL( PATTERNS_B_0C  ) , CTL( PATTERNS_A_0D  ) , CTL( PATTERNS_F_0C  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 0 ,TRANSPOSE[ 12 ]), &cb_patterns_0_0C	},
	{ COLUMN00-1, 0x11 	, CTL( PATTERNS_A_0C  )	, CTL( PATTERNS_B_0D  ) , CTL( PATTERNS_A_0E  ) , CTL( PATTERNS_F_0D  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 0 ,TRANSPOSE[ 13 ]), &cb_patterns_0_0D	},
	{ COLUMN00-1, 0x12 	, CTL( PATTERNS_A_0D  )	, CTL( PATTERNS_B_0E  ) , CTL( PATTERNS_A_0F  ) , CTL( PATTERNS_F_0E  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 0 ,TRANSPOSE[ 14 ]), &cb_patterns_0_0E	},
	{ COLUMN00-1, 0x13 	, CTL( PATTERNS_A_0E  )	, CTL( PATTERNS_B_0F  ) , CTL( SOLO_LEFT_00   ) , CTL( PATTERNS_F_0F  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 0 ,TRANSPOSE[ 15 ]), &cb_patterns_0_0F	},
	{ COLUMN01-1, 0x04 	, CTL( SOLO_LEFT_02   ) , CTL( PATTERNS_C_00  ) , CTL( PATTERNS_B_01  ) , CTL( PATTERNS_A_00  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 1 ,TRANSPOSE[  0 ]), &cb_patterns_1_00	},
	{ COLUMN01-1, 0x05 	, CTL( PATTERNS_B_00  )	, CTL( PATTERNS_C_01  ) , CTL( PATTERNS_B_02  ) , CTL( PATTERNS_A_01  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 1 ,TRANSPOSE[  1 ]), &cb_patterns_1_01	},
	{ COLUMN01-1, 0x06 	, CTL( PATTERNS_B_01  )	, CTL( PATTERNS_C_02  ) , CTL( PATTERNS_B_03  ) , CTL( PATTERNS_A_02  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 1 ,TRANSPOSE[  2 ]), &cb_patterns_1_02	},
	{ COLUMN01-1, 0x07 	, CTL( PATTERNS_B_02  )	, CTL( PATTERNS_C_03  ) , CTL( PATTERNS_B_04  ) , CTL( PATTERNS_A_03  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 1 ,TRANSPOSE[  3 ]), &cb_patterns_1_03	},
	{ COLUMN01-1, 0x08 	, CTL( PATTERNS_B_03  )	, CTL( PATTERNS_C_04  ) , CTL( PATTERNS_B_05  ) , CTL( PATTERNS_A_04  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 1 ,TRANSPOSE[  4 ]), &cb_patterns_1_04	},
	{ COLUMN01-1, 0x09 	, CTL( PATTERNS_B_04  )	, CTL( PATTERNS_C_05  ) , CTL( PATTERNS_B_06  ) , CTL( PATTERNS_A_05  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 1 ,TRANSPOSE[  5 ]), &cb_patterns_1_05	},
	{ COLUMN01-1, 0x0a 	, CTL( PATTERNS_B_05  )	, CTL( PATTERNS_C_06  ) , CTL( PATTERNS_B_07  ) , CTL( PATTERNS_A_06  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 1 ,TRANSPOSE[  6 ]), &cb_patterns_1_06	},
	{ COLUMN01-1, 0x0b 	, CTL( PATTERNS_B_06  )	, CTL( PATTERNS_C_07  ) , CTL( PATTERNS_B_08  ) , CTL( PATTERNS_A_07  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 1 ,TRANSPOSE[  7 ]), &cb_patterns_1_07	},
	{ COLUMN01-1, 0x0c 	, CTL( PATTERNS_B_07  )	, CTL( PATTERNS_C_08  ) , CTL( PATTERNS_B_09  ) , CTL( PATTERNS_A_08  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 1 ,TRANSPOSE[  8 ]), &cb_patterns_1_08	},
	{ COLUMN01-1, 0x0d 	, CTL( PATTERNS_B_08  )	, CTL( PATTERNS_C_09  ) , CTL( PATTERNS_B_0A  ) , CTL( PATTERNS_A_09  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 1 ,TRANSPOSE[  9 ]), &cb_patterns_1_09	},
	{ COLUMN01-1, 0x0e 	, CTL( PATTERNS_B_09  )	, CTL( PATTERNS_C_0A  ) , CTL( PATTERNS_B_0B  ) , CTL( PATTERNS_A_0A  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 1 ,TRANSPOSE[ 10 ]), &cb_patterns_1_0A	},
	{ COLUMN01-1, 0x0f 	, CTL( PATTERNS_B_0A  )	, CTL( PATTERNS_C_0B  ) , CTL( PATTERNS_B_0C  ) , CTL( PATTERNS_A_0B  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 1 ,TRANSPOSE[ 11 ]), &cb_patterns_1_0B	},
	{ COLUMN01-1, 0x10 	, CTL( PATTERNS_B_0B  )	, CTL( PATTERNS_C_0C  ) , CTL( PATTERNS_B_0D  ) , CTL( PATTERNS_A_0C  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 1 ,TRANSPOSE[ 12 ]), &cb_patterns_1_0C	},
	{ COLUMN01-1, 0x11 	, CTL( PATTERNS_B_0C  )	, CTL( PATTERNS_C_0D  ) , CTL( PATTERNS_B_0E  ) , CTL( PATTERNS_A_0D  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 1 ,TRANSPOSE[ 13 ]), &cb_patterns_1_0D	},
	{ COLUMN01-1, 0x12 	, CTL( PATTERNS_B_0D  )	, CTL( PATTERNS_C_0E  ) , CTL( PATTERNS_B_0F  ) , CTL( PATTERNS_A_0E  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 1 ,TRANSPOSE[ 14 ]), &cb_patterns_1_0E	},
	{ COLUMN01-1, 0x13 	, CTL( PATTERNS_B_0E  )	, CTL( PATTERNS_C_0F  ) , CTL( SOLO_LEFT_00   ) , CTL( PATTERNS_A_0F  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 1 ,TRANSPOSE[ 15 ]), &cb_patterns_1_0F	},
	{ COLUMN02-1, 0x04 	, CTL( SOLO_LEFT_02   ) , CTL( PATTERNS_D_00  ) , CTL( PATTERNS_C_01  ) , CTL( PATTERNS_B_00  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 2 ,TRANSPOSE[  0 ]), &cb_patterns_2_00	}, 
	{ COLUMN02-1, 0x05 	, CTL( PATTERNS_C_00  )	, CTL( PATTERNS_D_01  ) , CTL( PATTERNS_C_02  ) , CTL( PATTERNS_B_01  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 2 ,TRANSPOSE[  1 ]), &cb_patterns_2_01	}, 
	{ COLUMN02-1, 0x06 	, CTL( PATTERNS_C_01  )	, CTL( PATTERNS_D_02  ) , CTL( PATTERNS_C_03  ) , CTL( PATTERNS_B_02  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 2 ,TRANSPOSE[  2 ]), &cb_patterns_2_02	}, 
	{ COLUMN02-1, 0x07 	, CTL( PATTERNS_C_02  )	, CTL( PATTERNS_D_03  ) , CTL( PATTERNS_C_04  ) , CTL( PATTERNS_B_03  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 2 ,TRANSPOSE[  3 ]), &cb_patterns_2_03	}, 
	{ COLUMN02-1, 0x08 	, CTL( PATTERNS_C_03  )	, CTL( PATTERNS_D_04  ) , CTL( PATTERNS_C_05  ) , CTL( PATTERNS_B_04  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 2 ,TRANSPOSE[  4 ]), &cb_patterns_2_04	}, 
	{ COLUMN02-1, 0x09 	, CTL( PATTERNS_C_04  )	, CTL( PATTERNS_D_05  ) , CTL( PATTERNS_C_06  ) , CTL( PATTERNS_B_05  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 2 ,TRANSPOSE[  5 ]), &cb_patterns_2_05	}, 
	{ COLUMN02-1, 0x0a 	, CTL( PATTERNS_C_05  )	, CTL( PATTERNS_D_06  ) , CTL( PATTERNS_C_07  ) , CTL( PATTERNS_B_06  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 2 ,TRANSPOSE[  6 ]), &cb_patterns_2_06	}, 
	{ COLUMN02-1, 0x0b 	, CTL( PATTERNS_C_06  )	, CTL( PATTERNS_D_07  ) , CTL( PATTERNS_C_08  ) , CTL( PATTERNS_B_07  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 2 ,TRANSPOSE[  7 ]), &cb_patterns_2_07	}, 
	{ COLUMN02-1, 0x0c 	, CTL( PATTERNS_C_07  )	, CTL( PATTERNS_D_08  ) , CTL( PATTERNS_C_09  ) , CTL( PATTERNS_B_08  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 2 ,TRANSPOSE[  8 ]), &cb_patterns_2_08	}, 
	{ COLUMN02-1, 0x0d 	, CTL( PATTERNS_C_08  )	, CTL( PATTERNS_D_09  ) , CTL( PATTERNS_C_0A  ) , CTL( PATTERNS_B_09  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 2 ,TRANSPOSE[  9 ]), &cb_patterns_2_09	}, 
	{ COLUMN02-1, 0x0e 	, CTL( PATTERNS_C_09  )	, CTL( PATTERNS_D_0A  ) , CTL( PATTERNS_C_0B  ) , CTL( PATTERNS_B_0A  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 2 ,TRANSPOSE[ 10 ]), &cb_patterns_2_0A	}, 
	{ COLUMN02-1, 0x0f 	, CTL( PATTERNS_C_0A  )	, CTL( PATTERNS_D_0B  ) , CTL( PATTERNS_C_0C  ) , CTL( PATTERNS_B_0B  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 2 ,TRANSPOSE[ 11 ]), &cb_patterns_2_0B	}, 
	{ COLUMN02-1, 0x10 	, CTL( PATTERNS_C_0B  )	, CTL( PATTERNS_D_0C  ) , CTL( PATTERNS_C_0D  ) , CTL( PATTERNS_B_0C  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 2 ,TRANSPOSE[ 12 ]), &cb_patterns_2_0C	}, 
	{ COLUMN02-1, 0x11 	, CTL( PATTERNS_C_0C  )	, CTL( PATTERNS_D_0D  ) , CTL( PATTERNS_C_0E  ) , CTL( PATTERNS_B_0D  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 2 ,TRANSPOSE[ 13 ]), &cb_patterns_2_0D	}, 
	{ COLUMN02-1, 0x12 	, CTL( PATTERNS_C_0D  )	, CTL( PATTERNS_D_0E  ) , CTL( PATTERNS_C_0F  ) , CTL( PATTERNS_B_0E  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 2 ,TRANSPOSE[ 14 ]), &cb_patterns_2_0E	}, 
	{ COLUMN02-1, 0x13 	, CTL( PATTERNS_C_0E  )	, CTL( PATTERNS_D_0F  ) , CTL( SOLO_LEFT_00   ) , CTL( PATTERNS_B_0F  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 2 ,TRANSPOSE[ 15 ]), &cb_patterns_2_0F	}, 
	{ COLUMN03-1, 0x04 	, CTL( MUTE_LEFT_02   ) , CTL( PATTERNS_E_00  ) , CTL( PATTERNS_D_01  ) , CTL( PATTERNS_C_00  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 3 ,TRANSPOSE[  0 ]), &cb_patterns_3_00	},  
	{ COLUMN03-1, 0x05 	, CTL( PATTERNS_D_00  )	, CTL( PATTERNS_E_01  ) , CTL( PATTERNS_D_02  ) , CTL( PATTERNS_C_01  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 3 ,TRANSPOSE[  1 ]), &cb_patterns_3_01	},  
	{ COLUMN03-1, 0x06 	, CTL( PATTERNS_D_01  )	, CTL( PATTERNS_E_02  ) , CTL( PATTERNS_D_03  ) , CTL( PATTERNS_C_02  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 3 ,TRANSPOSE[  2 ]), &cb_patterns_3_02	},  
	{ COLUMN03-1, 0x07 	, CTL( PATTERNS_D_02  )	, CTL( PATTERNS_E_03  ) , CTL( PATTERNS_D_04  ) , CTL( PATTERNS_C_03  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 3 ,TRANSPOSE[  3 ]), &cb_patterns_3_03	},  
	{ COLUMN03-1, 0x08 	, CTL( PATTERNS_D_03  )	, CTL( PATTERNS_E_04  ) , CTL( PATTERNS_D_05  ) , CTL( PATTERNS_C_04  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 3 ,TRANSPOSE[  4 ]), &cb_patterns_3_04	},  
	{ COLUMN03-1, 0x09 	, CTL( PATTERNS_D_04  )	, CTL( PATTERNS_E_05  ) , CTL( PATTERNS_D_06  ) , CTL( PATTERNS_C_05  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 3 ,TRANSPOSE[  5 ]), &cb_patterns_3_05	},  
	{ COLUMN03-1, 0x0a 	, CTL( PATTERNS_D_05  )	, CTL( PATTERNS_E_06  ) , CTL( PATTERNS_D_07  ) , CTL( PATTERNS_C_06  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 3 ,TRANSPOSE[  6 ]), &cb_patterns_3_06	},  
	{ COLUMN03-1, 0x0b 	, CTL( PATTERNS_D_06  )	, CTL( PATTERNS_E_07  ) , CTL( PATTERNS_D_08  ) , CTL( PATTERNS_C_07  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 3 ,TRANSPOSE[  7 ]), &cb_patterns_3_07	},  
	{ COLUMN03-1, 0x0c 	, CTL( PATTERNS_D_07  )	, CTL( PATTERNS_E_08  ) , CTL( PATTERNS_D_09  ) , CTL( PATTERNS_C_08  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 3 ,TRANSPOSE[  8 ]), &cb_patterns_3_08	},  
	{ COLUMN03-1, 0x0d 	, CTL( PATTERNS_D_08  )	, CTL( PATTERNS_E_09  ) , CTL( PATTERNS_D_0A  ) , CTL( PATTERNS_C_09  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 3 ,TRANSPOSE[  9 ]), &cb_patterns_3_09	},  
	{ COLUMN03-1, 0x0e 	, CTL( PATTERNS_D_09  )	, CTL( PATTERNS_E_0A  ) , CTL( PATTERNS_D_0B  ) , CTL( PATTERNS_C_0A  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 3 ,TRANSPOSE[ 10 ]), &cb_patterns_3_0A	},  
	{ COLUMN03-1, 0x0f 	, CTL( PATTERNS_D_0A  )	, CTL( PATTERNS_E_0B  ) , CTL( PATTERNS_D_0C  ) , CTL( PATTERNS_C_0B  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 3 ,TRANSPOSE[ 11 ]), &cb_patterns_3_0B	},  
	{ COLUMN03-1, 0x10 	, CTL( PATTERNS_D_0B  )	, CTL( PATTERNS_E_0C  ) , CTL( PATTERNS_D_0D  ) , CTL( PATTERNS_C_0C  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 3 ,TRANSPOSE[ 12 ]), &cb_patterns_3_0C	},  
	{ COLUMN03-1, 0x11 	, CTL( PATTERNS_D_0C  )	, CTL( PATTERNS_E_0D  ) , CTL( PATTERNS_D_0E  ) , CTL( PATTERNS_C_0D  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 3 ,TRANSPOSE[ 13 ]), &cb_patterns_3_0D	},  
	{ COLUMN03-1, 0x12 	, CTL( PATTERNS_D_0D  )	, CTL( PATTERNS_E_0E  ) , CTL( PATTERNS_D_0F  ) , CTL( PATTERNS_C_0E  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 3 ,TRANSPOSE[ 14 ]), &cb_patterns_3_0E	},  
	{ COLUMN03-1, 0x13 	, CTL( PATTERNS_D_0E  )	, CTL( PATTERNS_E_0F  ) , CTL( MUTE_LEFT_00   ) , CTL( PATTERNS_C_0F  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 3 ,TRANSPOSE[ 15 ]), &cb_patterns_3_0F	},  
	{ COLUMN04-1, 0x04 	, CTL( MUTE_RIGHT_02  )	, CTL( PATTERNS_F_00  ) , CTL( PATTERNS_E_01  ) , CTL( PATTERNS_D_00  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 4 ,TRANSPOSE[  0 ]), &cb_patterns_4_00	},  
	{ COLUMN04-1, 0x05 	, CTL( PATTERNS_E_00  )	, CTL( PATTERNS_F_01  ) , CTL( PATTERNS_E_02  ) , CTL( PATTERNS_D_01  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 4 ,TRANSPOSE[  1 ]), &cb_patterns_4_01	},  
	{ COLUMN04-1, 0x06 	, CTL( PATTERNS_E_01  )	, CTL( PATTERNS_F_02  ) , CTL( PATTERNS_E_03  ) , CTL( PATTERNS_D_02  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 4 ,TRANSPOSE[  2 ]), &cb_patterns_4_02	},  
	{ COLUMN04-1, 0x07 	, CTL( PATTERNS_E_02  )	, CTL( PATTERNS_F_03  ) , CTL( PATTERNS_E_04  ) , CTL( PATTERNS_D_03  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 4 ,TRANSPOSE[  3 ]), &cb_patterns_4_03	},  
	{ COLUMN04-1, 0x08 	, CTL( PATTERNS_E_03  )	, CTL( PATTERNS_F_04  ) , CTL( PATTERNS_E_05  ) , CTL( PATTERNS_D_04  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 4 ,TRANSPOSE[  4 ]), &cb_patterns_4_04	},  
	{ COLUMN04-1, 0x09 	, CTL( PATTERNS_E_04  )	, CTL( PATTERNS_F_05  ) , CTL( PATTERNS_E_06  ) , CTL( PATTERNS_D_05  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 4 ,TRANSPOSE[  5 ]), &cb_patterns_4_05	},  
	{ COLUMN04-1, 0x0a 	, CTL( PATTERNS_E_05  )	, CTL( PATTERNS_F_06  ) , CTL( PATTERNS_E_07  ) , CTL( PATTERNS_D_06  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 4 ,TRANSPOSE[  6 ]), &cb_patterns_4_06	},  
	{ COLUMN04-1, 0x0b 	, CTL( PATTERNS_E_06  )	, CTL( PATTERNS_F_07  ) , CTL( PATTERNS_E_08  ) , CTL( PATTERNS_D_07  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 4 ,TRANSPOSE[  7 ]), &cb_patterns_4_07	},  
	{ COLUMN04-1, 0x0c 	, CTL( PATTERNS_E_07  )	, CTL( PATTERNS_F_08  ) , CTL( PATTERNS_E_09  ) , CTL( PATTERNS_D_08  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 4 ,TRANSPOSE[  8 ]), &cb_patterns_4_08	},  
	{ COLUMN04-1, 0x0d 	, CTL( PATTERNS_E_08  )	, CTL( PATTERNS_F_09  ) , CTL( PATTERNS_E_0A  ) , CTL( PATTERNS_D_09  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 4 ,TRANSPOSE[  9 ]), &cb_patterns_4_09	},  
	{ COLUMN04-1, 0x0e 	, CTL( PATTERNS_E_09  )	, CTL( PATTERNS_F_0A  ) , CTL( PATTERNS_E_0B  ) , CTL( PATTERNS_D_0A  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 4 ,TRANSPOSE[ 10 ]), &cb_patterns_4_0A	},  
	{ COLUMN04-1, 0x0f 	, CTL( PATTERNS_E_0A  )	, CTL( PATTERNS_F_0B  ) , CTL( PATTERNS_E_0C  ) , CTL( PATTERNS_D_0B  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 4 ,TRANSPOSE[ 11 ]), &cb_patterns_4_0B	},  
	{ COLUMN04-1, 0x10 	, CTL( PATTERNS_E_0B  )	, CTL( PATTERNS_F_0C  ) , CTL( PATTERNS_E_0D  ) , CTL( PATTERNS_D_0C  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 4 ,TRANSPOSE[ 12 ]), &cb_patterns_4_0C	},  
	{ COLUMN04-1, 0x11 	, CTL( PATTERNS_E_0C  )	, CTL( PATTERNS_F_0D  ) , CTL( PATTERNS_E_0E  ) , CTL( PATTERNS_D_0D  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 4 ,TRANSPOSE[ 13 ]), &cb_patterns_4_0D	},  
	{ COLUMN04-1, 0x12 	, CTL( PATTERNS_E_0D  )	, CTL( PATTERNS_F_0E  ) , CTL( PATTERNS_E_0F  ) , CTL( PATTERNS_D_0E  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 4 ,TRANSPOSE[ 14 ]), &cb_patterns_4_0E	},  
	{ COLUMN04-1, 0x13 	, CTL( PATTERNS_E_0E  )	, CTL( PATTERNS_F_0F  ) , CTL( MUTE_RIGHT_00  ) , CTL( PATTERNS_D_0F  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 4 ,TRANSPOSE[ 15 ]), &cb_patterns_4_0F	},  
	{ COLUMN05-1, 0x04 	, CTL( SOLO_RIGHT_02  )	, CTL( PATTERNS_A_00  ) , CTL( PATTERNS_F_01  ) , CTL( PATTERNS_E_00  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 5 ,TRANSPOSE[  0 ]), &cb_patterns_5_00	},  
	{ COLUMN05-1, 0x05 	, CTL( PATTERNS_F_00  )	, CTL( PATTERNS_A_01  ) , CTL( PATTERNS_F_02  ) , CTL( PATTERNS_E_01  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 5 ,TRANSPOSE[  1 ]), &cb_patterns_5_01	},  
	{ COLUMN05-1, 0x06 	, CTL( PATTERNS_F_01  )	, CTL( PATTERNS_A_02  ) , CTL( PATTERNS_F_03  ) , CTL( PATTERNS_E_02  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 5 ,TRANSPOSE[  2 ]), &cb_patterns_5_02	},  
	{ COLUMN05-1, 0x07 	, CTL( PATTERNS_F_02  )	, CTL( PATTERNS_A_03  ) , CTL( PATTERNS_F_04  ) , CTL( PATTERNS_E_03  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 5 ,TRANSPOSE[  3 ]), &cb_patterns_5_03	},  
	{ COLUMN05-1, 0x08 	, CTL( PATTERNS_F_03  )	, CTL( PATTERNS_A_04  ) , CTL( PATTERNS_F_05  ) , CTL( PATTERNS_E_04  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 5 ,TRANSPOSE[  4 ]), &cb_patterns_5_04	},  
	{ COLUMN05-1, 0x09 	, CTL( PATTERNS_F_04  )	, CTL( PATTERNS_A_05  ) , CTL( PATTERNS_F_06  ) , CTL( PATTERNS_E_05  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 5 ,TRANSPOSE[  5 ]), &cb_patterns_5_05	},  
	{ COLUMN05-1, 0x0a 	, CTL( PATTERNS_F_05  )	, CTL( PATTERNS_A_06  ) , CTL( PATTERNS_F_07  ) , CTL( PATTERNS_E_06  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 5 ,TRANSPOSE[  6 ]), &cb_patterns_5_06	},  
	{ COLUMN05-1, 0x0b 	, CTL( PATTERNS_F_06  )	, CTL( PATTERNS_A_07  ) , CTL( PATTERNS_F_08  ) , CTL( PATTERNS_E_07  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 5 ,TRANSPOSE[  7 ]), &cb_patterns_5_07	},  
	{ COLUMN05-1, 0x0c 	, CTL( PATTERNS_F_07  )	, CTL( PATTERNS_A_08  ) , CTL( PATTERNS_F_09  ) , CTL( PATTERNS_E_08  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 5 ,TRANSPOSE[  8 ]), &cb_patterns_5_08	},  
	{ COLUMN05-1, 0x0d 	, CTL( PATTERNS_F_08  )	, CTL( PATTERNS_A_09  ) , CTL( PATTERNS_F_0A  ) , CTL( PATTERNS_E_09  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 5 ,TRANSPOSE[  9 ]), &cb_patterns_5_09	},  
	{ COLUMN05-1, 0x0e 	, CTL( PATTERNS_F_09  )	, CTL( PATTERNS_A_0A  ) , CTL( PATTERNS_F_0B  ) , CTL( PATTERNS_E_0A  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 5 ,TRANSPOSE[ 10 ]), &cb_patterns_5_0A	},  
	{ COLUMN05-1, 0x0f 	, CTL( PATTERNS_F_0A  )	, CTL( PATTERNS_A_0B  ) , CTL( PATTERNS_F_0C  ) , CTL( PATTERNS_E_0B  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 5 ,TRANSPOSE[ 11 ]), &cb_patterns_5_0B	},  
	{ COLUMN05-1, 0x10 	, CTL( PATTERNS_F_0B  )	, CTL( PATTERNS_A_0C  ) , CTL( PATTERNS_F_0D  ) , CTL( PATTERNS_E_0C  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 5 ,TRANSPOSE[ 12 ]), &cb_patterns_5_0C	},  
	{ COLUMN05-1, 0x11 	, CTL( PATTERNS_F_0C  )	, CTL( PATTERNS_A_0D  ) , CTL( PATTERNS_F_0E  ) , CTL( PATTERNS_E_0D  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 5 ,TRANSPOSE[ 13 ]), &cb_patterns_5_0D	},  
	{ COLUMN05-1, 0x12 	, CTL( PATTERNS_F_0D  )	, CTL( PATTERNS_A_0E  ) , CTL( PATTERNS_F_0F  ) , CTL( PATTERNS_E_0E  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 5 ,TRANSPOSE[ 14 ]), &cb_patterns_5_0E	},  
	{ COLUMN05-1, 0x13 	, CTL( PATTERNS_F_0E  )	, CTL( PATTERNS_A_0F  ) , CTL( SOLO_RIGHT_00  ) , CTL( PATTERNS_E_0F  ) , &CACHE_HEXADECIMAL_DOUBLE		, VAR( 5 ,TRANSPOSE[ 15 ]), &cb_patterns_5_0F	},  
	#endif
...
void PatEdit::shift( int q ){
	...
	u16 carry = VAR_SONG.PATTERNS[ TRACKER_ACTIVE_CHANNEL ].ORDER[ expr ? 0 : 255 ];
	
	for(int i = 0; i<256; i++){
		VAR_SONG.PATTERNS[ TRACKER_ACTIVE_CHANNEL ].ORDER[ expr ? i&0xFF : 0xFF - (i&0xFF) ] = VAR_SONG.PATTERNS[ TRACKER_ACTIVE_CHANNEL ].ORDER[ expr ? (i+1)&0xFF : 0xFF - ((i+1)&0xFF) ];
	} 
	VAR_SONG.PATTERNS[ TRACKER_ACTIVE_CHANNEL ].ORDER[ expr ? 0xFF : 0x00] = carry;
