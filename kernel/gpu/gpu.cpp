...
void Gpu::init(){
	...
	// Load OBJ tilesets
	DmaCopy(3, TILESET_0,OBJ_MODE0_VRAM	, 4096, 16);//256 tiles
	DmaCopy(3, TILESET_1,OBJ_MODE0_VRAM+4096, 16384, 16);//512 tiles
	DmaCopy(3, TILESET_2,OBJ_MODE0_VRAM+20480, 8192, 16);//512 tiles
